...
1. Configure the project to use **JDK 25** (not other versions) as explained in [here](https://www.jetbrains.com/help/idea/sdk.html#set-up-jdk).<br>
   ...
   1. After that, locate the `src/main/java/harold/Harold.java` file, right-click it, and choose `Run Harold.main()` (if the code editor is showing compile errors, try restarting the IDE). If the setup is correct, you should see something like the below as the output:
      ```
        _   _                 _     _ 
       | | | | __ _ _ __ ___ | | __| |
       | |_| |/ _` | '__/ _ \| |/ _` |
